...
export { TYPES, CATEGORIES, STYLES, MOODS, MEDIUMS, COMPOSITIONS, buildTaxonomy, validateParsed, type Taxonomy, type TaxonomyOverrides, type ValidationResult } from "./taxonomy.js";
